...
it('sells products', async () => {
    ...
    //check wheather the seller gets fund or not
    ...
    newSellerBalance = new web3.utils.BN(newSellerBalance)
     ...
     //Failures:tries to buy a product that does not exist, product must have a valid id
    ...
    //FIALURE:buyer tries to buy again, ie buyer cant be the seller
